...
class Kruskal {
	...
	void applyKruskal() {
		...
		// use for loop to pick the smallers edge from the edges and increment the index
		// for next iteration
		while (newEdge < vertices - 1) {
			...
			// if the edge doesn't create cycle after including it, we add it in the result
	...
	public static void main(String[] args) {
		...
		Kruskal graph = new Kruskal(v, e); // use for creating Graph
